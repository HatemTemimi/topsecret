<template>
    <v-card class="w-full p-4 hidden md:block lg:block ">
    <div class="flex flex-row justify-between items-center">
      <!-- Filters Block -->
      <div name="filters" class="flex flex-row gap-4 items-center">
        <!-- Region Selection -->
        <div class="sm:hidden md:block md:w-56 lg: min-w-[200px]">
          <v-select
      ...
      <div name="buttons" class="flex flex-row gap-2 ml-4">
        <v-btn size="small" color="primary" @click="resetFilters">Reset</v-btn>
      </div>
    </div>
</v-card>
</template>
